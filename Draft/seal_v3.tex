...
the gab between GA and NSGA-II narrows and eventually exceeds NSGA-II.
...
\begin{figure}[H]
	...
	\end{subfigure}%
	%\begin{subfigure}[b]{0.3\textwidth}
		%\includegraphics[width=\textwidth]{pics/pop_50_gen_50_3_times_3_good.png}
		%\caption{good}
	%\end{subfigure}
	%\begin{subfigure}[b]{0.3\textwidth}
		%\includegraphics[width=\textwidth]{pics/pop_50_gen_50_3_times_3_poor.png}
		%\caption{poor}
	%\end{subfigure}
	\begin{subfigure}[b]{0.3\textwidth}
