...
%because of both matrices are relatively small, it is easy for NSGA-II to find near optimal solutions. Therefore, there is
...
\begin{figure}[H]
	...
	%\begin{subfigure}[b]{0.49\textwidth}
		%\includegraphics[width=\textwidth]{pics/pop_50_gen_50.49_times_3_good.png}
		%\caption{good}
	%\end{subfigure}
	%\begin{subfigure}[b]{0.49\textwidth}
		%\includegraphics[width=\textwidth]{pics/pop_50_gen_50.49_times_3_poor.png}
		%\caption{poor}
	%\end{subfigure}
	\begin{subfigure}[b]{0.45\textwidth}
...
%\begin{figure}[H]
	...
	%\end{subfigure}
	%%\begin{subfigure}[b]{0.49\textwidth}
		%\includegraphics[width=\textwidth]{pics/pop_50_gen_50_5_times_5_good.png}
		%\caption{good}
	%\end{subfigure}
	%\begin{subfigure}[b]{0.49\textwidth}
		%\includegraphics[width=\textwidth]{pics/pop_50_gen_50_5_times_5_poor.png}
		%\caption{poor}
	%\end{subfigure}
	%\begin{subfigure}[b]{0.49\textwidth}
		%\includegraphics[width=\textwidth]{pics/pop_50_gen_50_5_times_5_minimum.png}
...
\begin{figure}[H]
	...
	\end{subfigure}%
	%\begin{subfigure}[b]{0.49\textwidth}
		%\includegraphics[width=\textwidth]{pics/pop_50_gen_50_10_times_10_good.png}
		%\caption{good}
	%\end{subfigure}
	%\begin{subfigure}[b]{0.49\textwidth}
		%\includegraphics[width=\textwidth]{pics/pop_50_gen_50_10_times_10_poor.png}
		%\caption{poor}
	%\end{subfigure}
	\begin{subfigure}[b]{0.45\textwidth}
...
%\begin{figure}[H]
	...
	%\end{subfigure}
	%\begin{subfigure}[b]{0.49\textwidth}
		%\includegraphics[width=\textwidth]{pics/pop_50_gen_50_15_times_15_good.png}
		%\caption{good}
	%\end{subfigure}
	%\begin{subfigure}[b]{0.49\textwidth}
		%\includegraphics[width=\textwidth]{pics/pop_50_gen_50_15_times_15_poor.png}
		%\caption{poor}
	%\end{subfigure}
	%\begin{subfigure}[b]{0.49\textwidth}
		%\includegraphics[width=\textwidth]{pics/pop_50_gen_50_15_times_15_minimum.png}
