...
requested from a set of location $I = \{ i_{1}, i_{2}, ..., i_{i} \}$. The service providers allocate services 
to $J = \{ j_{1}, j_{2}, ..., j_{j} \}$ be the set of candidate facility locations.
...
\begin{algorithm}
	...
	\begin{algorithmic}[1]
		...
		\State Close down a service from a random location as long as it does not violate service number constraint
